...
/* TrafficLightController::TRAFFIC_PHASE_Type/ */
typedef enum kcg_tag_TRAFFIC_PHASE_Type_TrafficLightController {
  LIGHT_TRAFFIC_PHASE_TrafficLightController,
  MODERATE_TRAFFIC_PHASE_TrafficLightController,
  PEAK_TRAFFIC_PHASE_TrafficLightController
} TRAFFIC_PHASE_Type_TrafficLightController;
/* TrafficLightController::AutomaticMode/AutomaticMode: */
typedef enum kcg_tag_SSM_TR_AutomaticMode {
  SSM_TR_no_trans_AutomaticMode
} SSM_TR_AutomaticMode;
/* TrafficLightController::AutomaticMode/AutomaticMode: */
typedef enum kcg_tag_SSM_ST_AutomaticMode {
  SSM_st_AutomaticMode_AutomaticMode
} SSM_ST_AutomaticMode;
/* TrafficLightController::AutomaticMode/AutomaticMode:AutomaticMode:PhaseTransition: */
typedef enum kcg_tag_SSM_TR_PhaseTransition_AutomaticMode_AutomaticMode {
  SSM_TR_no_trans_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_LightTrafficPhase_ModerateTrafficMode_1_LightTrafficPhase_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_LightTrafficPhase_PeakTrafficMode_2_LightTrafficPhase_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_ModerateTrafficMode_PeakTrafficMode_1_ModerateTrafficMode_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_ModerateTrafficMode_LightTrafficPhase_2_ModerateTrafficMode_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_PeakTrafficMode_ModerateTrafficMode_1_PeakTrafficMode_PhaseTransition_AutomaticMode_AutomaticMode,
  SSM_TR_PeakTrafficMode_LightTrafficPhase_2_PeakTrafficMode_PhaseTransition_AutomaticMode_AutomaticMode
} SSM_TR_PhaseTransition_AutomaticMode_AutomaticMode;
/* TrafficLightController::AutomaticMode/AutomaticMode:AutomaticMode:PhaseTransition: */
typedef enum kcg_tag_SSM_ST_PhaseTransition_AutomaticMode_AutomaticMode {
...
} SSM_ST_PhaseTransition_AutomaticMode_AutomaticMode;

...
/* TrafficLightController::S_signal/, TrafficLightController::SouthSignal/ */
typedef int_TrafficLightController S_signal_TrafficLightController[3];

#ifndef kcg_copy_S_signal_TrafficLightController
#define kcg_copy_S_signal_TrafficLightController(kcg_C1, kcg_C2)              \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (S_signal_TrafficLightController)))
#endif /* kcg_copy_S_signal_TrafficLightController */

#ifdef kcg_use_S_signal_TrafficLightController
#ifndef kcg_comp_S_signal_TrafficLightController
extern kcg_bool kcg_comp_S_signal_TrafficLightController(
  S_signal_TrafficLightController *kcg_c1,
  S_signal_TrafficLightController *kcg_c2);
#endif /* kcg_comp_S_signal_TrafficLightController */

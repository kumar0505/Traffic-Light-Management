...
/* TrafficLightController::NorthToSouth/STE: */
typedef enum kcg_tag_SSM_TR_STE {
  SSM_TR_no_trans_STE,
  SSM_TR_Running_Stopping_1_Running_STE
} SSM_TR_STE;
/* TrafficLightController::NorthToSouth/STE: */
...
typedef array_int8_3 E_Signal_TrafficLightController;

/* TrafficLightController::S_signal/ */
typedef array_int8_3 S_signal_TrafficLightController;

/* TrafficLightController::N_signal/ */
typedef array_int8_3 N_signal_TrafficLightController;
...
#define kcg_comp_N_signal_TrafficLightController kcg_comp_array_int8_3

#define kcg_copy_N_signal_TrafficLightController kcg_copy_array_int8_3

#define kcg_comp_S_signal_TrafficLightController kcg_comp_array_int8_3

#define kcg_copy_S_signal_TrafficLightController kcg_copy_array_int8_3

#define kcg_comp_E_Signal_TrafficLightController kcg_comp_array_int8_3

#define kcg_copy_E_Signal_TrafficLightController kcg_copy_array_int8_3

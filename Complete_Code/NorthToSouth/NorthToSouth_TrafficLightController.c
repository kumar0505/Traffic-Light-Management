  ...
  outC_NorthToSouth_TrafficLightController *outC)
{
  ...
  /* _L14=(TrafficLightController::Counter#3)/ */
  Counter_TrafficLightController(
    inC->Time_NtoS - kcg_lit_int8(5),
  ...
  switch (STE_state_act) {
    case SSM_st_Stopping_STE :
      /* STE:Stopping:_L9=(TrafficLightController::EastSignal#7)/ */
      ...
      break;
    case SSM_st_Running_STE :
      /* STE:Running:_L9=(TrafficLightController::EastSignal#6)/ */
      EastSignal_TrafficLightController(
        kcg_lit_int8(1),
        kcg_lit_int8(0),
        kcg_lit_int8(0),

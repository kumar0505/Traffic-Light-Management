...
/* TrafficLightController::MANUAL_SIGNAL_TYPE/ */
typedef enum kcg_tag_MANUAL_SIGNAL_TYPE_TrafficLightController {
  SET_E_TO_N_SIGNAL_TrafficLightController,
  SET_S_TO_E_SIGNAL_TrafficLightController,
  SET_N_TO_S_SIGNAL_TrafficLightController
} MANUAL_SIGNAL_TYPE_TrafficLightController;
/* TrafficLightController::ManualMode/ManualMode: */
typedef enum kcg_tag_SSM_TR_ManualMode {
  SSM_TR_no_trans_ManualMode,
  SSM_TR_North_To_South_South_To_East_1_North_To_South_ManualMode,
  SSM_TR_North_To_South_East_To_North_2_North_To_South_ManualMode,
  SSM_TR_South_To_East_East_To_North_1_South_To_East_ManualMode,
  SSM_TR_South_To_East_North_To_South_2_South_To_East_ManualMode,
  SSM_TR_East_To_North_North_To_South_1_East_To_North_ManualMode,
  SSM_TR_East_To_North_South_To_East_2_East_To_North_ManualMode
} SSM_TR_ManualMode;
/* TrafficLightController::ManualMode/ManualMode: */
typedef enum kcg_tag_SSM_ST_ManualMode {
  SSM_st_North_To_South_ManualMode,
  SSM_st_South_To_East_ManualMode,
  SSM_st_East_To_North_ManualMode
} SSM_ST_ManualMode;
#endif /* _KCG_TYPES_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
** kcg_types.h

...
/* TrafficLightController::TRAFFIC_MODE_Type/ */
typedef enum kcg_tag_TRAFFIC_MODE_Type_TrafficLightController {
  AUTOMATIC_MODE_TrafficLightController,
  MANUAL_MODE_TrafficLightController
} TRAFFIC_MODE_Type_TrafficLightController;
/* TrafficLightController::ModeTransition/ModeTransition: */
typedef enum kcg_tag_SSM_TR_ModeTransition {
  SSM_TR_no_trans_ModeTransition,
  SSM_TR_AutomaticMode_ManualMode_1_AutomaticMode_ModeTransition,
  SSM_TR_ManualMode_AutomaticMode_1_ManualMode_ModeTransition
} SSM_TR_ModeTransition;
/* TrafficLightController::ModeTransition/ModeTransition: */
typedef enum kcg_tag_SSM_ST_ModeTransition {
  SSM_st_AutomaticMode_ModeTransition,
  SSM_st_ManualMode_ModeTransition
} SSM_ST_ModeTransition;
#endif /* _KCG_TYPES_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
** kcg_types.h
** Generation date: 2020-06-09T12:45:14
